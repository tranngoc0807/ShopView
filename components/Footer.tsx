        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><div className="hover:text-white">Liên hệ</div></li>
              <li><div className="hover:text-white">Vận chuyển</div></li>
              <li><div className="hover:text-white">Đổi trả</div></li>
              <li><div className="hover:text-white">Hướng dẫn chọn size</div></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><div className="hover:text-white">Giới thiệu</div></li>
              <li><div className="hover:text-white">Bền vững</div></li>
              <li><div className="hover:text-white">Tuyển dụng</div></li>
              <li><div className="hover:text-white">Chính sách bảo mật</div></li>
              <li><div className="hover:text-white">Điều khoản</div></li>
            </ul>
          </div>
        </div>
